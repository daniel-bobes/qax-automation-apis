...
Framework de automatización de pruebas para la API de **[JSONPlaceholder API](https://jsonplaceholder.typicode.com/)**, desarrollado con un enfoque profesional y mantenible.
...
│   └── test
│       ├── java
│       │   └── com.danielbobes.api.challenges.jsonplaceholder
