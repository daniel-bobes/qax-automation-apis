...
@SelectClasspathResource("features/jsonplaceholder/comments")
// Define el paquete donde se ubican las clases que implementan los pasos de los escenarios
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.danielbobes.api.challenges.jsonplaceholder.steps.comments")
